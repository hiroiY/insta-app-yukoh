  ...
  <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      @foreach($all_categories as $category)
        ...
        <!-- 
          ...
          in_array(1,$slelected_categories)x
          in_array(2,$slelected_categories)x
          in_array(3,$slelected_categories)o
          in_array(4,$slelected_categories)x
          in_array(5,$slelected_categories)o
          in_array(6,$slelected_categories)o
    ...
    <div class="row mb-4">
      <div class="col-6">
        ...
        <button type="submit" class="btn btn-primary px-5 btn-wawrning">Save</button>
  </form>
@endsection